...
# 3 - Excuse - A little bit of fun in the hectic IT world.
#
...
function Disable-ADUser{
    ...
    do{
        ...
        } catch [System.Management.Automation.ParameterBindingValidationException] {  #[Microsoft.ActiveDirectory.Management.ADIdentityNotFoundException]
